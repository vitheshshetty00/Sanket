...
const Detect = () => {
	...
	useEffect(() => {
		async function loadGestureRecognizer() {
			...
			const recognizer = await GestureRecognizer.createFromOptions(vision, {
				baseOptions: {
					modelAssetPath:
						// "/home/vithesh/python projects/Sign-Language-Recognition-Using-Mediapipe-and-React/Code For Training the Model/exported_model/gesture_recognizer.task"
						// "https://storage.googleapis.com/mediapipe-tasks/gesture_recognizer/gesture_recognizer.task"
						"https://firebasestorage.googleapis.com/v0/b/sign-language-ai-1d7e4.appspot.com/o/gesture_recognizer.task?alt=media&token=e1d4f51e-432b-4c5a-bbd6-2af9555ec151",
	...
	//     const modelRef = storage.refFromURL('gs://sign-language-ai-1d7e4.appspot.com/gesture_recognizer.task');

	//     // Get the download URL
	//     modelRef.getDownloadURL().then(async function(url) {
	//       console.log(url);
	//       const recognizer = await GestureRecognizer.createFromOptions(vision, {
	//         baseOptions: {
	//           modelAssetPath: url
